...
const token = '6441829539:AAGymdI87Ejrc5uj7KKx18vgPV9Iil9G1YU'
    ...
    bot.on('message', async msg => {
        ...
        try {
            if (text === '/start') {
                ...
                await bot.sendSticker(chatId, 'https://tlgrm.eu/_/stickers/a12/164/a1216452-0494-353a-8b90-8d00340f7657/1.webp')
